...
export const TIMELINE_HOURLY_TABLET_PROPORTION = TIMELINE_TABLET_SECTION_WIDTH / MINUTES_PER_HOUR
export const TIMELINE_DAILY_TABLET_PROPORTION = TIMELINE_TABLET_SECTION_WIDTH / HOURS_PER_DAY
export const TIMELINE_MONTHLY_TABLET_PROPORTION = TIMELINE_TABLET_SECTION_WIDTH / DAYS_PER_MONTH
