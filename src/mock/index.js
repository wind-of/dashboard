...
const task = (title = "Task #" + rn(), description = "Description", tags = generateTags(1)) => ({ id: uid("tag"), title, description, tags })
const column = (title = "Column #" + rn(), tasks = generateTasks(3)) => ({ id: uid("tag"), title, tasks })
